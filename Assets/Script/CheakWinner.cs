...
public class CheakWinner : MonoBehaviour
{
    public static CheakWinner Instance;
    ...
    private void LateUpdate()
    {
        if (target != null && isWinner)
        {
            ...
            playerRotation.LookAt(new Vector3( winnerCamera.transform.position.x, playerRotation.position.y, winnerCamera.transform.position.z));
        }
    }
